...
from vllm_ascend.pdmix.sched.output import BatchType  # noqa: E402
from vllm_ascend.pdmix.sched.passive_scheduler import (  # noqa: E402
...
def test_subscriber_thread_bridges_inbox():
    ...
    with patch("vllm_ascend.envs.VLLM_ASCEND_PDMIX_LAYER_SLICE_SIZE", 0):
        scheduler = PassiveScheduler(
